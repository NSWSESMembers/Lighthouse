        ...
        var filtermenu = `<li class="">
            ...
            <ul class="sub-menu " style="display: none;">
              ...
              <a>Job Status</a>
                ...
                <span class="label tag tag-lighthouse" id="filerallstatus"><span class="tag-text"><img width="14px" style="width:14px;vertical-align:top;margin-right:5px" src="$LHURLlh-black.png">All Jobs</span></span>
                </span>
                <span class="twitter-typeahead" style="margin-left:5px;margin-bottom:10px;position:relative;display:inline-block;direction:ltr">
                <a>Job Type</a>
                ...
                <span class="label tag tag-lighthouse" id="fileralltype"><span class="tag-text"><img width="14px" style="width:14px;vertical-align:top;margin-right:5px" src="$LHURLlh-black.png">All Job Types</span></span>
                </span>
                <span class="twitter-typeahead" style="margin-left:5px;margin-bottom:10px;position:relative;display:inline-block;direction:ltr">
                <a>Locations</a>
