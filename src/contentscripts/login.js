...
$('body')
  ...
  $('body').css({ 'background-image': 'url('+chrome.extension.getURL("icons/lhbackdrop.png")+')','background-repeat': 'no-repeat', 'background-size': '80% 80%','background-position-x': '100%','background-position-y': '100%'})
