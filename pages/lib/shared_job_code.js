...
function GetJSONfromBeacon(unit, host, StartDate, EndDate, userId = 'notPassed', token, callback, progressCallBack, viewmodel) {
...
function GetSummaryJSONfromBeacon(unit, host, StartDate, EndDate, userId = 'notPassed', token, callback, progressCallBack) {
    var url = "";
...
function GetJobfromBeacon(Id, viewModelType = 1, host, userId = 'notPassed', token, callback) {
  $.ajax({
    type: 'GET',
